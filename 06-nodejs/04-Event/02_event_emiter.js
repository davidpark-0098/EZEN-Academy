...
class Radio extends EventEmitter {
  // 클래스의 상속이 이루어 졌으므로 생성자에게 상위 클래스의 생성자를 호출하도록 지정한다. --> 상속구현
...
radio.on('turnon', (channel) => console.log('Hello RAdio ' + channel)); // 익명함수는 이벤트를 제거할 수 없다.
radio.addListener('changechannel', (channel) => console.log('채널이 %d 번으로 변경되었습니다.', channel)); // on과 addListener 차이는 없다.
...
/** 8. 이벤트 제거하기 */
radio.removeAllListeners('turnon', onTurnOn);
